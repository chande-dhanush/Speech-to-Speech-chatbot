    ...
    if any(command in user_input.lower() for command in ['play', 'who is', 'joke', 'stop listening']):
        ...
        chat_completion = client.chat.completions.create(
            messages=[
                {
                    "role": "system",
                    "content": "You're a smart mature woman named Sakura, keep your replies ,humble,polite,respectful and reply within 1 short statement, you're 20 years old and u love to text that person and u flirt sometimes"
                },
                {
                    "role": "user",
                    "content": user_input
